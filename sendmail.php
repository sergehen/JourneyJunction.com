...
<head>
    ...
    <link rel="shortcut icon" href="images/nlog.ico">
...
<body class="bod">
		...
		<fieldset>
			...
			<input class="inp" type="text" name="first_name" id="first_name" value="<?php echo $_REQUEST['first_name'] ?>" disabled><br>
			<label class="lab" for="last_name">Last Name:</label>
			<input class="inp" type="text" name="last_name" id="last_name" value="<?php echo $_REQUEST['last_name'] ?>" disabled><br>
        	<label class="lab" for="email">Email Address:</label>
        	<input class="inp" type="email" name="email" id="email" value="<?php echo $_REQUEST['email'] ?>" disabled><br>
        	<label class="lab"for="verify">Verify Email:</label>
        	<input class="inp" type="email" name="verify" id="verify" value="<?php echo $_REQUEST['email'] ?>" disabled><br>
			<label class="lab" for="phone">Phone Number:</label>
			<input type="tel" name="phone" id="phone" value="<?php echo $_REQUEST['phone'] ?>" disabled><br>
		</fieldset>
		<fieldset>
    		<legend class="leg">Message Information</legend>
			<label class="lab" for="reservation_date">Today's  Date:</label>
			<input class="inp" type="date" name="reservation_date" id="reservation_date" value="<?php echo $_REQUEST['reservation_date'] ?>" disabled><br>
			<label class="lab" for="subject">Subject:</label>
			<input class="inp" type="text" name="subject" id="subject" value="<?php echo $_REQUEST['subject'] ?>" disabled><br>
...
<?php
  ...
  //Set admin email for email to be sent to (use you own MATC email address)
    $admin_email = "henrys15@gmatc.matc.edu"; 
